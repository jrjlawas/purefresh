            ...
            >
              <div className="vl-section-title-1">
                ...
                <h2 className="title text-anime-style-3">
                  Heroes in Action Disaster Relief Fundraiser
                </h2>
                <p
                  className="pb-32"
                  data-aos="fade-right"
                  ...
                  data-aos-delay={300}
                >
                  Our events are more than just gatherings they <br /> powerful
                  opportunities to bring communities <br /> together, raise
                ...
                <div
                  ...
                  data-aos-delay={300}
                >
                  <Link to="/event-single" className="header-btn1">
                    Vineyard Venues{" "}
                    <span>
                      <FaArrowRight />
                    </span>
                      ...
                      <Row>
                        <Col lg={8} md={8}>
                          <div className="vl-single-blog-box-content">
                            ...
                            <h4 className="title">
                              <Link to="/event-single">{item.title}</Link>
                            </h4>
